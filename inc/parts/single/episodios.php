...
//WTSmovies
$tms_url_torrent='https://autoembed.to/torrent/tv/';
$tms_url_subtitles='https://autoembed.to/subtitles/tv/';
// End PHP
// End PHP
if ( ! empty( $player ) ) {
	$StreamalyPlayer = [
                    ...
                    <div class="links_table">
                        <div class="fix-table">
                            <table>
                                ...
                                <tr id="link-1">
                                    <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=<?php echo $tms_url_torrent.$tmdbids.'-'.$temporad.'-'.$episode ?>"> <a href="<?php echo $tms_url_torrent.$tmdbids.'-'.$temporad.'-'.$episode ?>" target="_blank">Download Torrent: <?php the_title(); ?></a></td>
                                    <td>Torrent</td>
                                    <td>1080p | 720p | 360p</td>
                                </tr>

                                <tr id="link-2">
                                    <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=<?php echo $tms_url_subtitles.$tmdbids.'-'.$temporad.'-'.$episode ?>"> <a href="<?php echo $tms_url_subtitles.$tmdbids.'-'.$temporad.'-'.$episode ?>" target="_blank">Download Subtitles: <?php the_title(); ?></a></td>
                                    <td>Subtitles</td>
                                    <td>SRT | VTT</td>
                                </tr>
