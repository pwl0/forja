...
$imdb_id = doo_isset($postmeta,'idtmdb');
//  Image
...
//WTSmovies
$tms_url_torrent='https://autoembed.to/torrent/movie/';
$tms_url_subtitles='https://autoembed.to/subtitles/movie/';
                    ...
                    <div class="links_table">
                        <div class="fix-table">
                            <table>
                                ...
                                <tbody>
                                <tr id="link-1">
                                    <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=<?php echo $tms_url_torrent.$imdb_id ?>"> <a href="<?php echo $tms_url_torrent.$imdb_id ?>" target="_blank">Download Torrent: <?php the_title(); ?></a></td>
                                    <td>Torrent</td>
                                    <td>1080p | 720p | 360p</td>
                                </tr>
                                <tr id="link-2">
                                    <td><img src="https://s2.googleusercontent.com/s2/favicons?domain=<?php echo $tms_url_subtitles.$imdb_id ?>"> <a href="<?php echo $tms_url_subtitles.$imdb_id ?>" target="_blank">Download Subtitles: <?php the_title(); ?></a></td>
                                    <td>Subtitles</td>
                                    <td>SRT | VTT</td>
                                </tr>
                                </tbody>
