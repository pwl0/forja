...
<table class="form-table dbmv">
    <tbody>
        ...
        <tr valign="top">
            <th scope="row" class="titledesc">
                <label for="dbmv-input-dbmovies">API Key for Dbmovies</label>
            </th>
            <td class="jump status valid">
                <fieldset><input id="dbmv-input-dbmovies" type="text" name="dbmvsettings[dbmovies]" value="6bb18caf566b52cad79435b982d88b46" placeholder=""><p>Your API key will give you access to all our services</p></fieldset>
            </td>
        </tr>
        <tr valign="top">
            <th scope="row" class="titledesc">
